...
document.write('	<li onclick="window.open(\'files/CV.pdf\')" id="header_cv">CV</li>');
...
document.write('	<li onclick="window.open(\'thoughts.html\',\'_self\')" id="header_thoughts">My Thoughts</li>');
document.write('</ul>');
document.write('</header>');